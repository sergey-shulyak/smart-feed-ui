...
class PublicationPage extends React.PureComponent {
    render() {
        const { classes, author, createdAt, text } = this.props;
                ...
                <Grid container spacing={24}>
                    ...
                    <Grid item xs={8}>
                        <Card className={classes.card}>
                            <CardHeader className={classes.cardHeader} title="Publication title" subheader={getPublicationSubheader(author, createdAt)} />
                            <CardContent>
